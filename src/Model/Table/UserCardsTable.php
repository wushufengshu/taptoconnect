 ...
 *
 * @method \App\Model\Entity\UserCard newEmptyEntity()
 * @method \App\Model\Entity\UserCard newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\UserCard[] patchEntities(iterable $entities, array $data, array $options = [])
 ...
 * @method \App\Model\Entity\UserCard[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\UserCard[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\UserCard[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\UserCard[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 *
